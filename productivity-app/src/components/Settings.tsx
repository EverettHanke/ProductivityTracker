...
const Settings = ({ backgroundUrl, setBackgroundUrl }: SettingsProps) => {
    ...
    const preBakedBackgrounds = [
        ...
        { label: 'Abstract Waves', url: '../src/assets/ChillPinkWaves.gif' },
        { label: 'Blue Stars', url: '../src/assets/BlueStars.gif' },
        { label: 'Cherry Blossums', url: '../src/assets/CherryBlossums.gif' },
        { label: 'City Skyline', url: '../src/assets/Skylines.gif' },
        { label: 'Tower in the woods', url: '../src/assets/Tower.gif' },
